...
static void node_sph_fluid_exec(ExeParams params) {
  ...
  auto num_particle_per_axis =
      params.get_input<pxr::GfVec3f>("num particle per axis");

  if (particle_box_max[0] <= particle_box_min[0] ||
      particle_box_max[1] <= particle_box_min[1] ||
      particle_box_max[2] <= particle_box_min[2] ||
      particle_box_max[0] > sim_box_max[0] ||
      particle_box_min[0] < sim_box_min[0] ||
      particle_box_max[1] > sim_box_max[1] ||
      particle_box_min[1] < sim_box_min[1] ||
      particle_box_max[2] > sim_box_max[2] ||
      particle_box_min[2] < sim_box_min[2]) {
